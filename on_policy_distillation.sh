...
# export TRAIN_DATASET_NAME=DAPO-Math-17k-1percentIMO
...
TEST_DATASET=${TEST_FILE:-["$TEST_DATA_DIR/AIME25/test.parquet", "$TEST_DATA_DIR/AIMO/test.parquet", "$TEST_DATA_DIR/AIME24/test.parquet"]}
...
# export ACTOR_MODEL_PATH=your_path/Qwen3/Qwen3-4B
export ACTOR_MODEL_PATH=your_path/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
...
export REWARD_MODEL_PATH=your_path/models/JustRL-DeepSeek-1.5B

export REWARD_MODEL_NAME=$(basename "$REWARD_MODEL_PATH")

export PROJECT_PATH=your_path/ckpt/OPD/ckpts
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.output_log_path=../ckpt/OPD/logs/terminal/${EXPERIMENT_NAME}.log \
    trainer.project_name=$PROJECT_NAME \
    trainer.experiment_name=$EXPERIMENT_NAME \
    trainer.validation_data_dir=../ckpt/OPD/logs/validation_log/$EXPERIMENT_NAME \
