...
# export ACTOR_MODEL_PATH=/ossfs/workspace/aitech_aidata/chuwei/models/Qwen/Qwen3-1.7B-Base
# export ACTOR_MODEL_PATH=/ossfs/workspace/aitech_aidata/chuwei/ckpt/OPD/sft/Qwen3-1.7B-Base-SFT-OpenThought3-4B/checkpoint-852-normal-sft
export ACTOR_MODEL_PATH=/ossfs/workspace/aitech_aidata/chuwei/ckpt/OPD/sft/Qwen3-1.7B-Base-SFT-OpenThought3-4B-preserve-ts6-beta-1.0-Tem-0.9/checkpoint-6812-ts6-Tem-0.9
export ACTOR_MODEL_NAME=$(basename "$ACTOR_MODEL_PATH")
export REWARD_MODEL_PATH=/ossfs/workspace/aml0/Qwen3/Qwen3-4B
...
export PROJECT_PATH=/ossfs/workspace/aitech_aidata/chuwei/ckpt/OPD/ckpts
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.output_log_path=/ossfs/workspace/aitech_aidata/chuwei/ckpt/OPD/logs/terminal/${EXPERIMENT_NAME}.log \
